...
let pressureAltitudeUnits = document.getElementById("pressureAltitude_id");
...
if (altitude = 1000){
  v1 = Math.pow(72/45, 1/40) ** temperature * 290 * (44/29)**(1/4);
} 
  ...
  v1 = Math.pow(140/113, 1/40) ** temperature * 565 * (140/113)**(1/4);
}
