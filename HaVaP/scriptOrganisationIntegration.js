...
regNumber.addEventListener('change', function() {
    ...
    if (selectedValueOrg === 'omkla') {
        airemptmassOrg.value = 532;
        airemptmomentOrg.value = 160590;
    }
    if (selectedValueOrg === 'omkls') {
        airemptmassOrg.value = 515;
        airemptmomentOrg.value = 160590;
    }
...
regNumber.addEventListener('change', function() {
    const selectedValueOrg = this.value;
    if (selectedValueOrg === 'omivi') {
        airemptmassOrg.value = 520;
        airemptmomentOrg.value = 160590;
    }
    if (selectedValueOrg === 'omlov') {
        airemptmassOrg.value = 520;
        airemptmomentOrg.value = 160590;
    }
    if (selectedValueOrg === 'omlif') {
        airemptmassOrg.value = 520;
        airemptmomentOrg.value = 160500;
    }
})
